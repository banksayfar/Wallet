    ...
    <div id="loginbox" style="margin-top:50px;" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
      <div class="panel panel-info" >
          ...
          <div style="padding-top:0px" class="panel-body" >
              ...
              <form action="do_register.php" method="POST" id="loginform" class="form-horizontal" role="form" style="margin-top: 20px">
                          ...
                          <div class="form-group">
                            <div class="col-md-12 control" style="text-align: center;">
                              <div style="border-top: 1px solid#888; padding-top:15px; font-size:85%" >
                                  <button  type="submit" class="btn btn-primary"  >  SIGN UP  </button>
                                  <a  href="login.php" type="button " class="btn btn-danger" name="save" > CANCEL</a>
                              </div>
                            </div>
                          </div>
                  </form>
